...
(function(global, $){
	...
	Meio.Autocomplete = new Class({
		...
		setupList: function(){
			if (this.options.tokenize && this.options.tokenize.get) {
				this.inputedText = this.options.tokenize.get(this.elements.field.node);
			}
			else {
		...
		setInputValue: function(){
			...
			if (list.focusedItem){
				...
				if (this.options.tokenize && this.options.tokenize.set) {
					this.options.tokenize.set(this.elements.field.node, text);
				}
				else {
