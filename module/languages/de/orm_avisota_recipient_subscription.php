...
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['confirmationSent']['0']             = 'Bestätigung gesendet am';
...
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['list']['1']                         = 'Bitte wählen Sie das Abonnement aus';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['new']['0']                          = 'Neues Abonnement';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['new']['1']                          = 'Fügen Sie ein neues Abonnement hinzu.';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['recipient']['0']                    = 'Empfänger';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['reminderCount']['0']                = 'Erinnerung gesendet';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['reminderSent']['0']                 = 'Erinnerung gesendet am';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['show']['0']                         = 'Abonnementsdetails';
$GLOBALS['TL_LANG']['orm_avisota_recipient_subscription']['show']['1']                         = 'Zeigen Sie die Details des Abonnements %s an.';
